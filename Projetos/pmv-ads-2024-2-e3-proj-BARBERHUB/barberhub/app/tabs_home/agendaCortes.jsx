...
import ImageViewer from "@/components/ImageViewerCortes";
import CalendarViewer from "@/components/CalendarViewer";

const PlaceholderImage = require("@/assets/images/HomeCabelo.png");

export default function AgendaCorteScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: "Estilos de cortes" }} />
