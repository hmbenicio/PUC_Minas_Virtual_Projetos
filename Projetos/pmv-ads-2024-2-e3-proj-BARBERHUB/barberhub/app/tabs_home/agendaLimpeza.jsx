...
import ImageViewer from "@/components/ImageViewerLimpeza";
import CalendarViewer from "@/components/CalendarViewer";

const PlaceholderImage = require("@/assets/images/HomeLimpeza.png");

export default function AgendaLimpezaScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: "Limpeza de pele" }} />
